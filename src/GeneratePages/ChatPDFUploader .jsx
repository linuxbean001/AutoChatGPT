...
function ChatPDFUploader() {
  ...
  const handlePdfFileSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      fetch("http://127.0.0.1:5000/api/uploadPdf", requestOptions)
        ...
        .then((data) => {
          if (data.message === "File uploaded successfully") {
            ...
            reader.onload = function(event) {
              ...
              localStorage.setItem("ViewPdf", base64String);
        ...
        <div className="container mx-auto px-4 upload-box">
          <form onSubmit={handlePdfFileSubmit}>
            ...
            <div className="icon" onClick={() => fileInputRef.current.click()}>
              <img src="https://www.ezcopy.net/wp-content/uploads/2018/02/upload-1.png" alt="Upload" />
            </div>
            ...
            <button
              ...
              style={{backgroundColor:"#54aedd" , padding:"8px", width:"130px", color:"white", borderRadius:"5px"}}
            >
              UPLOAD
            </button>
          </form>
